...
pub unsafe trait GcHeap: 'static + Send + Sync {
    ...
    /// determines which kind of object is allocated. The layout of the two is
    /// identical; exception objects simply reserve their leading
    /// `EXN_ENGINE_FIELDS` fields for the engine's use.
