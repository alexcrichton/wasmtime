...
impl dsl::Operand {
    ...
    pub fn generate_type(&self) -> Option<String> {
        ...
        match self.location.kind() {
            ...
            FixedReg(dx | edx | rdx) => Some(format!("Gpr<R::{}Rdx>", self.mutability.generate_type())),
    ...
    #[must_use]
    pub fn generate_mut_ty(&self, read_ty: &str, read_write_ty: &str, write_ty: &str) -> String {
        use dsl::Mutability::*;
        use dsl::OperandKind::*;
...
impl dsl::Location {
    ...
    pub fn generate_type(&self, generic: Option<String>) -> Option<String> {
        ...
        match self {
            al | ax | eax | rax | cl | dx | edx | rdx => None,
            imm8 => Some("Imm8".into()),
